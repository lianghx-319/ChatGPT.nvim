...
- Custom OpenAI API host

In some countries, it is too hard to accessing OpenAI, setup your custom API host following this way:

1. Setting it via an environment variable called `$OPENAI_API_HOST`.
